    ...
    var body: some View {
        GroupBox {
            ...
            VStack(alignment: .leading, spacing: 12) {
                // Always-visible Gamer Score row
                HStack(spacing: 10) {
                    Text("Gamer Score:")
                        .font(.headline)
                ...
                // Always-visible Player Stat Sheet
        ...
        .onAppear {
            // Ensure we recompute once when the card becomes visible,
            // even if the last external update happened earlier.
            version &+= 1
        }
